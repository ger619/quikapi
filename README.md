...
>Rails QuikAPI banking App app is a Ruby on Rails application that keeps track and transfer cash.
...
git clone https://github.com/ger619/quikapi.git  <Your-Build-Directory>
``` 
- cd quikapi
- rails s
```
